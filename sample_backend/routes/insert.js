  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <a href="http://104.154.141.198:5001/update-status?phone_no=${userDetails.phone_no}&status=verified"
           style="padding:10px 20px;background-color:#4CAF50;color:white;text-decoration:none;border-radius:4px;">✅ Approve</a>
        &nbsp;
        <a href="http://104.154.141.198:5001/update-status?phone_no=${userDetails.phone_no}&status=rejected"
           style="padding:10px 20px;background-color:#f44336;color:white;text-decoration:none;border-radius:4px;">❌ Reject</a>
        &nbsp;
        <a href="http://104.154.141.198:5001/update-status?phone_no=${userDetails.phone_no}&status=in%20progress"
